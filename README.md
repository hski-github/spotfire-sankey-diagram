...
- Currently the order of values is done alphabetically, as an alternative option could be sorted by highest value, but also custom order should be supported https://ideas.tibco.com/ideas/TS-I-8062 resp. https://github.com/hski-github/spotfire-sankey-diagram/issues/21
